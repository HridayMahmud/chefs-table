...
const Banner = () => {
  return (
    <div  style={{backgroundImage:`url(${img})`,backgroundSize:"cover",backgroundPosition:"center;",backgroundRepeat:"no-repeat;",height:"600px;",borderRadius:"24px"}} className='banner-container  px-48 mb-24 py-32 text-center'>
